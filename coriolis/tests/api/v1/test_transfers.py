...
class TransferControllerTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_show(
        ...
        mock_get_bool_url_arg.assert_called_once_with(
            mock_req, 'include_task_info', False)
    ...
    def test_list(
        ...
        mock_get_bool_url_arg.side_effect = [None, False]
        ...
        expected_calls = [
            mock.call(mock_req, 'show_deleted', None),
            mock.call(mock_req, 'include_task_info', False)
        ]
